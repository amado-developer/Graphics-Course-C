...
private:
    ...
    vector<tuple<int, int>> polygonBorders;
...
public:
    ...
    void fillPolygon(vector<int> xCoordinates, vector<int> yCoordinates);
    bool isInside(int x, int y, vector<int> xCoordinates, vector<int> yCoordinates);
