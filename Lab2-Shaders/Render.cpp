...
void Render::setActiveRender(vector<double>(*activeShader)
        (double &u, double &v, double &w,
         ...
         tuple<double, double, double> &light, vector<double>))
{
...
)
{
    ...
    for(auto x{xMin}; x <= xMax; ++x)
    {
        for(auto y{yMin}; y <= yMax; ++y)
        {
            ...
            if(y >= 375 && y <= 410)
            {
                color = this->activeShader(u, v, w, tA, tB, tC, nA, nB, nC, this->light, {0.09, 0.12, 0.3});
            }

            if(y > 410 && y <= 470)
            {
                color = this->activeShader(u, v, w, tA, tB, tC, nA, nB, nC, this->light, {49.0/255.0, 61.0/255.0, 173.0/255.0});
            }

            if(y > 470 && y <= 540)
            {
                color = this->activeShader(u, v, w, tA, tB, tC, nA, nB, nC, this->light, {68.0/255.0, 101.0/255.0, 255.0/255.0});
            }

            if(y > 540 && y <= 600) {
                color = this->activeShader(u, v, w, tA, tB, tC, nA, nB, nC, this->light,
                                           {73.0 / 255.0, 110.0 / 255.0, 255.0 / 255.0});
            }

            if(y > 600 && y <= 650) {
                color = this->activeShader(u, v, w, tA, tB, tC, nA, nB, nC, this->light,
                                           {55.0 / 255.0, 69.0 / 255.0, 206.0 / 255.0});
            }

            if(y > 650) {
                color = this->activeShader(u, v, w, tA, tB, tC, nA, nB, nC, this->light,
                                           {53.0 / 255.0, 62.0 / 255.0, 187.0 / 255.0});
            }
